  ...
  const renderContent = () => {
    switch (currentView) {
      ...
      case "all-products":
        return (
          <ProductListPage
            ...
            title="All Products"
            description="Browse our complete collection of premium leather goods, handcrafted with care and attention to detail."
            onBack={handleBackToHome}
      ...
      case "bags":
        return (
          <ProductListPage
            products={getBagProducts()}
            title="Bags Collection"
            description="Discover our selection of premium leather bags, from everyday totes to professional briefcases."
            onBack={handleBackToHome}
            onProductClick={handleProductClick}
          />
        );
      ...
      case "purses":
        return (
          <ProductListPage
            products={getPurseProducts()}
            title="Purses & Wallets Collection"
            description="Explore our range of elegant wallets and purses, designed for both style and functionality."
            onBack={handleBackToHome}
            onProductClick={handleProductClick}
          />
        );
      ...
      case "belts":
        return (
          <ProductListPage
            products={getBeltProducts()}
            title="Belts Collection"
            description="Complete your look with our handcrafted leather belts, made to last a lifetime."
            onBack={handleBackToHome}
            onProductClick={handleProductClick}
          />
        );
    ...
    <>
      ...
      >
        ...
        <div className="relative z-10 text-center text-white max-w-4xl px-4">
          ...
          >
            Discover handcrafted leather goods that blend
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            ...
            >
              ...
              <p className="text-muted-foreground">
                Only the finest full-grain leather, carefully
                selected for durability and beauty
              </p>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, y: 50 }}
            ...
            >
              ...
              <p className="text-muted-foreground">
                Each piece is meticulously crafted by skilled
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Explore our carefully curated selection of premium
              leather goods
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="mb-4 text-muted-foreground">
                For over a decade, Addict Hawk has been
                committed to creating exceptional leather goods
                that stand the test of time. Our journey began
                in a small workshop with a simple vision: to
                craft products that combine traditional
                techniques with contemporary design.
              </p>
              <p className="mb-4 text-muted-foreground">
                Every piece we create tells a story of
                dedication, skill, and attention to detail. We
                source the finest full-grain leather from
                sustainable tanneries and work with master
                artisans who bring decades of experience to
                every stitch.
              </p>
              <p className="mb-8 text-muted-foreground">
                Our commitment to quality means that each
                product is not just an accessory, but an
                investment that will develop its own unique
                character over the years, becoming more
                beautiful with age.
              </p>
              <motion.div
                whileHover={{ scale: 1.05 }}
